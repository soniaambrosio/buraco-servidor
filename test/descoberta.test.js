...
// ===========================================================================
// [OS 44] CENSO RECÍPROCO — acrescentado pela composição, nada removido.
//
// Esta suíte é uma das protegidas e uma das que protegem. O portão deste
// repositório é um GLOB, e glob não sabe o que deveria existir: apagar
// `assento_autoritativo.test.js` ou a suíte de costura faria os casos delas
// sumirem com o portão VERDE. Com o censo chamado das três, tirar qualquer uma
// deixa as outras duas vermelhas. Ver `test/censo_de_suites.js`.
// ===========================================================================
test("§0 — as suítes obrigatórias da composição continuam no portão", () => {
  conferirCenso();
});
